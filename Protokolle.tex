		...
		\begin{center}
			...
			\hfill
				...
				\emph{Aufgabenstellung:} \\
						Vergleich verschiedener OSI Layer 2 Protokolle im Bezug auf die Spezifikation des OSI-Models
...
Diese Identitätsprüfung stellt einen eigenen Zustand dar, dieser nennt sich \glqq Authentifizieren\grqq . Tritt in diesem Zustand ein Fehler auf, wird die Verbindung beendet und der Verbindungsaufbau wechselt  in den Ausgangszustand \glqq{Beenden}\grqq , der Träger wird wieder freigegeben.
