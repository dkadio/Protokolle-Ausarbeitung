...
\subsubsection{Adressierung}
LAPD nutzt zur Adressierung der Teilnehmer den TEI, Terminal Endpoint Identifier. Den TEI wird entweder durch eine feste Einstellung im Endgerät oder durch die Vergabe der Vermittlungsstelle vergeben.

\subsection{Frames}
LAPD teilt die Daten der Schicht 3 in Frames auf. Ein Frame ist ist folgendermaßen aufgebaut:
...
Die Blockbegrenzung ist eine Byte, das aus eine Bitkombination besteht, die im restlichen Block nicht vorkommt. Sie stellt den Anfang und das Ende des Blocks dar. \textcolor{red}{\textbf{Sollen wir das noch genauer ausführen?}}  . Das Adressfeld besteht aus 2 Bytes, die die SAPI und die TEI enthalten. Der SAPI, Service Access Point Identifier,  identifiziert die Dienste der Schicht 2.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{Grafiken/LAPD-Rahmen.jpg}
